...
{
    private const string PortalName = "SuperAdmin";
    private const string ConfirmationPath = "/superadmin/security/email-change/confirm";
    private const string LoginPath = "/superadmin/login";
        ...
        CancellationToken cancellationToken)
    {
        ...
        var callback = Url.Action(
            ...
            "Security",
            new { area = "SuperAdmin", userId = user.Id, newEmail = input.NewEmail.Trim(), token = result.Token },
            Request.Scheme)!;
        ...
        return LocalRedirect("/superadmin/security#email-security");
    }
