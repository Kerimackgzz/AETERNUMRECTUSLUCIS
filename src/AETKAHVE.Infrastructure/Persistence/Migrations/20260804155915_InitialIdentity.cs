    ...
    public partial class InitialIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ManagementSessions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ManagementSessions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_IsActive_DeletedAtUtc",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_AdminUserId_ActionType",
                table: "AuditLogs",
                columns: new[] { "AdminUserId", "ActionType" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ManagementSessions_AbsoluteExpiresAtUtc",
                table: "ManagementSessions",
                column: "AbsoluteExpiresAtUtc");

            migrationBuilder.CreateIndex(
                name: "IX_ManagementSessions_UserId_Portal_RevokedAtUtc",
                table: "ManagementSessions",
                columns: new[] { "UserId", "Portal", "RevokedAtUtc" });
        }
